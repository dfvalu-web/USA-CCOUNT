...
export class SoftwareMigrationEngine {
  ...
  public static INITIAL_PACKAGES: ImportedStatementPackage[] = [
    {
      id: 'MIG-QBO-MILLA-2025',
      companyName: 'Milla Maid Services LLC',
      sourceSoftware: 'QUICKBOOKS_ONLINE',
      statementType: 'GENERAL_LEDGER_ENTRIES',
      periodStart: '2021-11-09',
      periodEnd: '2025-12-31',
      totalDebits: 6088212.95,
      totalCredits: 6088212.95,
      isBalanced: true,
      varianceAmount: 0.0,
      importedAt: '2026-08-21T12:00:00Z',
      status: 'POSTED_TO_LEDGER',
      rawLines: [
        { sourceAccountCode: '1000', sourceAccountName: 'Initiate Business Checking (9342)', sourceAccountType: 'ASSET', debit: 2154000, credit: 0, netBalance: 2154000 },
        { sourceAccountCode: '1010', sourceAccountName: 'Money Market Account', sourceAccountType: 'ASSET', debit: 176095, credit: 0, netBalance: 176095 },
        { sourceAccountCode: '1020', sourceAccountName: 'SIGNIFY BUSINESS CASH', sourceAccountType: 'ASSET', debit: 94500, credit: 0, netBalance: 94500 },
        { sourceAccountCode: '1200', sourceAccountName: 'Accounts Receivable (A/R)', sourceAccountType: 'ASSET', debit: 62400, credit: 0, netBalance: 62400 },
        { sourceAccountCode: '2000', sourceAccountName: 'Georgia Department of Revenue Payable', sourceAccountType: 'LIABILITY', debit: 0, credit: 14200, netBalance: -14200 },
        { sourceAccountCode: '2100', sourceAccountName: 'Accounts Payable Suppliers', sourceAccountType: 'LIABILITY', debit: 0, credit: 18795, netBalance: -18795 },
        { sourceAccountCode: '3000', sourceAccountName: 'Opening Balance Equity & Retained Earnings', sourceAccountType: 'EQUITY', debit: 0, credit: 450000, netBalance: -450000 },
        { sourceAccountCode: '4000', sourceAccountName: 'Cleaning & Janitorial Services Revenue', sourceAccountType: 'REVENUE', debit: 0, credit: 1664000, netBalance: -1664000 },
        { sourceAccountCode: '5000', sourceAccountName: 'Subcontractor Labor 1099 Expenses', sourceAccountType: 'EXPENSE', debit: 655846, credit: 0, netBalance: 655846 },
        { sourceAccountCode: '5100', sourceAccountName: 'Direct Labor W-2 Wages', sourceAccountType: 'EXPENSE', debit: 256187, credit: 0, netBalance: 256187 },
        { sourceAccountCode: '6000', sourceAccountName: 'Legal & Accounting Professional Fees', sourceAccountType: 'EXPENSE', debit: 142162, credit: 0, netBalance: 142162 },
        { sourceAccountCode: '6100', sourceAccountName: 'Vehicle, Fuel & Road Services', sourceAccountType: 'EXPENSE', debit: 25082, credit: 0, netBalance: 25082 },
      ],
      mappings: [
        { sourceAccountCode: '1000', sourceAccountName: 'Initiate Business Checking (9342)', targetAccountCode: '1010', targetAccountName: 'Operating Checking Account (Cash)', targetAccountType: 'ASSET', confidenceScore: 99, status: 'MANUALLY_CONFIRMED' },
        { sourceAccountCode: '1010', sourceAccountName: 'Money Market Account', targetAccountCode: '1010', targetAccountName: 'Operating Checking Account (Cash)', targetAccountType: 'ASSET', confidenceScore: 99, status: 'MANUALLY_CONFIRMED' },
        { sourceAccountCode: '1020', sourceAccountName: 'SIGNIFY BUSINESS CASH', targetAccountCode: '1010', targetAccountName: 'Operating Checking Account (Cash)', targetAccountType: 'ASSET', confidenceScore: 95, status: 'MANUALLY_CONFIRMED' },
        { sourceAccountCode: '1200', sourceAccountName: 'Accounts Receivable (A/R)', targetAccountCode: '1100', targetAccountName: 'Accounts Receivable (A/R)', targetAccountType: 'ASSET', confidenceScore: 100, status: 'MANUALLY_CONFIRMED' },
        { sourceAccountCode: '2000', sourceAccountName: 'Georgia Department of Revenue Payable', targetAccountCode: '2110', targetAccountName: 'State Sales Tax Payable', targetAccountType: 'LIABILITY', confidenceScore: 100, status: 'MANUALLY_CONFIRMED' },
        { sourceAccountCode: '2100', sourceAccountName: 'Accounts Payable Suppliers', targetAccountCode: '2010', targetAccountName: 'Accounts Payable (A/P)', targetAccountType: 'LIABILITY', confidenceScore: 100, status: 'MANUALLY_CONFIRMED' },
        { sourceAccountCode: '3000', sourceAccountName: 'Opening Balance Equity & Retained Earnings', targetAccountCode: '3020', targetAccountName: 'Members Capital Account (IRC 704b)', targetAccountType: 'EQUITY', confidenceScore: 96, status: 'MANUALLY_CONFIRMED' },
        { sourceAccountCode: '4000', sourceAccountName: 'Cleaning & Janitorial Services Revenue', targetAccountCode: '4020', targetAccountName: 'Commercial Cleaning & Service Revenue', targetAccountType: 'REVENUE', confidenceScore: 100, status: 'MANUALLY_CONFIRMED' },
        { sourceAccountCode: '5000', sourceAccountName: 'Subcontractor Labor 1099 Expenses', targetAccountCode: '5020', targetAccountName: '1099 Independent Contractor Fees', targetAccountType: 'EXPENSE', confidenceScore: 100, status: 'MANUALLY_CONFIRMED' },
        { sourceAccountCode: '5100', sourceAccountName: 'Direct Labor W-2 Wages', targetAccountCode: '5010', targetAccountName: 'Direct Labor Salaries (W-2 Wages)', targetAccountType: 'EXPENSE', confidenceScore: 100, status: 'MANUALLY_CONFIRMED' },
        { sourceAccountCode: '6000', sourceAccountName: 'Legal & Accounting Professional Fees', targetAccountCode: '6050', targetAccountName: 'Legal, CPA & Professional Advisory Fees', targetAccountType: 'EXPENSE', confidenceScore: 100, status: 'MANUALLY_CONFIRMED' },
        { sourceAccountCode: '6100', sourceAccountName: 'Vehicle, Fuel & Road Services', targetAccountCode: '6040', targetAccountName: 'Vehicle & Equipment Operations', targetAccountType: 'EXPENSE', confidenceScore: 95, status: 'MANUALLY_CONFIRMED' },
      ],
    },
    {
      id: 'MIG-QBO-901',
